...
const STEPS = [
  ...
  { id: "lifestyle", label: "Health & Lifestyle", icon: <FaHeartbeat /> },
    ...
    <div className="client-shell">
      ...
      <main className="client-content">
        <form onSubmit={handleSubmit}>
          ...
          {/* ---- Lifestyle ---- */}
          <section id="lifestyle" className="client-section">
            <header className="client-section-head">
              <span className="client-section-tag">Step 3</span>
              <h2>Health &amp; Lifestyle</h2>
              <p>These factors feed directly into your AI risk assessment.</p>
            </header>
