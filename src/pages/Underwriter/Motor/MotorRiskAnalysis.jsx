    ...
    <div className="mra-page">
      ...
      <div className="mra-fleet-summary">
        <div className="mra-fleet-gauge">
          <RiskGauge score={fleetResult.fleet_risk_score} label="Fleet Risk Score" size={190} />
        </div>
      ...
      <div className="mra-result-shell">
        <aside className="mra-result-aside">
          <RiskGauge score={active.result.risk_score} label="Vehicle Risk Score" size={200} />
          <div className="mra-confidence-box">
            <h4>Model Confidence</h4>
            <p className="mono">{active.result.confidence}%</p>
          </div>
